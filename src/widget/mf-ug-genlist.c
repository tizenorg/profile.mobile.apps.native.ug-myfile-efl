...
static Evas_Object *__mf_ug_genlist_create_thumbnail(void *data, Evas_Object *obj)
{
	...
	evas_object_size_hint_min_set(thumb, w, h);
...
Evas_Object *mf_ug_genlist_delete_style_create(void *data)
{
	...
	ugd->ug_Status.ug_1text2icon4_itc.item_style = "default";
...
Evas_Object *__mf_ug_genlist_create_gl(void *data)
{
	...
	ugd->ug_Status.ug_1text3icon_itc.item_style = "default";
	...
	ugd->ug_Status.ug_1text2icon_itc.item_style = "default";
	...
	if (ugd->ug_UiGadget.ug_iSelectMode == MULTI_FILE_MODE ||
		...
		ugd->ug_Status.ug_1text1icon_itc.item_style = "default";
